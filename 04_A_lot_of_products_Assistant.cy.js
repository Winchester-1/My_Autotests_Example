...
describe('a lot of products SPD', () => {
  ...
  it('saving the order number', () => {
    cy.get('[name="prefbaPreparationOrder"]').then(($number) => {
      prepOrderNumber = $number.text();
    })
  })
  ...
  it('clicking Submit for assistant creation', () => {
    cy.get('[name="FbaSubmitForAssistantCreationBtn"]')
      .wait(3000)
      .click()
  })
  ...
  it('log in', () => {
    cy.get(el.loginField)
      .clear()
      .type(el.assistantLogin)

    cy.get(el.passwordField)
      .clear()
      .type(el.assistantPassword)
  ...
  it('searching the order', () => {
    cy.get('[name="inptSearch"]')
      .should('be.visible')
      .wait(2000)
      .type(prepOrderNumber)
      .type('{enter}')
  })

  it('clicking view shipment', () => {
    cy.get('[name="assistAction"]:eq(1)')
      .click()
  })
  ...
  it('filling tracking bumber field', () => {
    cy.get('[name="shipping_labels_row"].visible-flex > [name="coastTrackNumBlock"] > [name="fiveStepTrackNumBlock"] > [name="trackNumInput"]')
      .click()
      .clear()
      .type('22211111{enter}')
  })
  ...
  it('clicking shipping labels button', () => {
    cy.get('[name="shipping_labels_row"].visible-flex > [name="upl_bot_block"] > [name="upl_shipping_labels_btn"]')
      .should('be.visible')
      .click()
  })
