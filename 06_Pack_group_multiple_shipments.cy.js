...
describe('a lot of products SPD', () => {
  ...
  it('click add additional shipment button', () => {
    cy.get('[name="prep_pack_group"].visible-flex > [name="addAdditionalShipment"]:eq(0)')
      .click()
  })
  ...
  it('click add additional shipment button', () => {
    cy.get('[name="prep_pack_group"].visible-flex > [name="addAdditionalShipment"]:eq(1)')
      .click()
  })

  it('filling shipment id field', () => {
    cy.get('[name="pack_group_step5_block"].visible-flex > div > div > div > [name="fiveStepShipmentIDInput"]:eq(3)')
      .click()
      .should('be.visible')
      .clear()
      .type('44444{enter}')
  ...
  it('filling ship to adress field', () => {
    cy.get('[name="pack_group_step5_block"].visible-flex > div > div > [name="fiveStepShipToAddressInput"]:eq(3)')
      .should('be.visible')
      .clear()
      .type('44444{enter}')
  })
  ...
  it('filling tracking bumber field', () => {
    cy.get('[name="shipping_labels_row"].visible-flex > [name="coastTrackNumBlock"] > [name="fiveStepTrackNumBlock"] > [name="trackNumInput"]:eq(3)')
      .click()
      .clear()
      .type('22211111{enter}')
  })
  ...
  it('clicking shipping labels button', () => {
    cy.get('[name="shipping_labels_row"].visible-flex > [name="upl_bot_block"] > [name="upl_shipping_labels_btn"]:eq(3)')
      .should('be.visible')
      .click()
  })
  ...
  it('download pack group 3 file', () => {
    cy.get('[name="prep_pack_group"].visible-flex > div > div > [name="download_plan_mod"]:eq(4)')
      .click()
  })

  it('filling shipment id field', () => {
    cy.get('[name="pack_group_step5_block"].visible-flex > div > div > div > [name="fiveStepShipmentIDInput"]:eq(4)')
      .click()
      .should('be.visible')
      .clear()
      .type('44444{enter}')
  ...
  it('filling ship to adress field', () => {
    cy.get('[name="pack_group_step5_block"].visible-flex > div > div > [name="fiveStepShipToAddressInput"]:eq(4)')
      .should('be.visible')
      .clear()
      .type('44444{enter}')
  })
  ...
  it('filling tracking bumber field', () => {
    cy.get('[name="shipping_labels_row"].visible-flex > [name="coastTrackNumBlock"] > [name="fiveStepTrackNumBlock"] > [name="trackNumInput"]:eq(4)')
      .click()
      .clear()
      .type('22211111{enter}')
  })
  ...
  it('clicking shipping labels button', () => {
    cy.get('[name="shipping_labels_row"].visible-flex > [name="upl_bot_block"] > [name="upl_shipping_labels_btn"]:eq(4)')
      .should('be.visible')
      .click()
  })
  ...
  it('checking the pack group and shipment', () => {
    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_num"]:eq(0)')
      .should('contain', '1')

    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_ship_num"]:eq(0)')
      .should('contain', '1')
  })

  it('download shipping file', () => {
    cy.get('[name="packGroupShipInfoRow"].visible-flex > [name="packGroupShipInfoRow_shipping_dwn"]:eq(0)')
      .click()
  })

  it('checking the pack group and shipment', () => {
    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_num"]:eq(1)')
      .should('contain', '1')

    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_ship_num"]:eq(1)')
      .should('contain', '2')
  })
  ...
  it('checking the pack group and shipment', () => {
    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_num"]:eq(2)')
      .should('contain', '2')

    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_ship_num"]:eq(2)')
      .should('contain', '1')
  })
  ...
  it('checking the pack group and shipment', () => {
    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_num"]:eq(3)')
      .should('contain', '2')

    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_ship_num"]:eq(3)')
      .should('contain', '2')
  })

  it('download shipping file', () => {
    cy.get('[name="packGroupShipInfoRow"].visible-flex > [name="packGroupShipInfoRow_shipping_dwn"]:eq(3)')
      .click()
  })

  it('checking the pack group and shipment', () => {
    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_num"]:eq(4)')
      .should('contain', '3')

    cy.get('[name="packGroupFilesRow"].visible-flex > div > div > [name="packGroupFilesRow_ship_num"]:eq(4)')
      .should('contain', '1')
  })

  it('download shipping file', () => {
    cy.get('[name="packGroupShipInfoRow"].visible-flex > [name="packGroupShipInfoRow_shipping_dwn"]:eq(4)')
      .click()
  })
